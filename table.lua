...
function FixUserdata(u) -- Skidded from simplespy source, credits to him (made performance fixes btw)
...
table.stringify = function(t, bool) -- stringifies the given table
...
local tbl = {"a", ["a"] = "t'\"", "\n"}
tbl[tbl] = tbl
print(table.stringify(tbl))

print(table.parse(table.stringify(tbl))["a"])
local Results = {}
